...
const statusConfig = {
    processing: { label: "Diproses", className: "bg-blue-500/10 text-blue-600 border-blue-500/20", dot: "bg-blue-500" },
    ready: { label: "Siap", className: "bg-primary/5 text-primary border-primary/10", dot: "bg-primary" },
    delivered: { label: "Selesai", className: "bg-muted text-muted-foreground border-border", dot: "bg-muted-foreground/50" },
};
...
function DashboardMockup() {
    return (
        <div className="relative w-full py-[clamp(2rem,5vw,3rem)] px-0">
            <div className="mx-auto max-w-7xl rounded-[2rem] rounded-b-none bg-muted/50 p-[clamp(1rem,3vw,4rem)] border border-border/50 shadow-inner">
                <div className="relative mx-auto w-full max-w-5xl">
                    <BrowserMockup url="app.beres.io/dashboard">
                        <div className="flex" style={{ height: "clamp(320px, 50vw, 560px)" }}>
                            ...
                            <div className="hidden sm:flex w-[clamp(9rem,14vw,14rem)] shrink-0 flex-col gap-1 border-r border-border bg-muted/30 px-3 py-4">
                                ...
                                {[
                                    ...
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            item.active ? "bg-primary text-white" : "text-muted-foreground hover:bg-muted"
                                        )}
                                    >
                                        <item.icon className={cn("h-3.5 w-3.5", item.active ? "text-white" : "text-muted-foreground/70")} />
                                        {item.label}
                                    </div>
                                ))}
                            </div>
                            ...
                            {/* Main content */}
                            <div className="flex-1 overflow-hidden bg-muted/10 p-[clamp(0.75rem,2vw,1.25rem)]">

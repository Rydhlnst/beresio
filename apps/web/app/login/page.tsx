...
import { GoogleIcon } from "@/app/_components/icons/google"; // I'll create this or use a simple one
        ...
        <div className="flex min-h-[calc(100vh-64px)] items-center justify-center p-4">
            <Card className="w-full max-w-md border-border/40 shadow-xl bg-background/50 backdrop-blur-xl">
                <CardHeader className="space-y-1 text-center">
                    <CardTitle className="text-3xl font-bold tracking-tight">Selamat Datang Kembali</CardTitle>
                    <CardDescription className="text-muted-foreground">
                        Masukkan email Anda untuk masuk ke akun beres.io
                    </CardDescription>
                </CardHeader>
                ...
                <CardFooter className="flex flex-wrap items-center justify-center gap-1 text-sm text-muted-foreground border-t border-border/10 pt-6">
                    Belum punya akun?{" "}
